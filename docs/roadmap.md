...
> 更新：2026-09-04 · 当前状态：**单引擎化（Rime）已定案并实机验证**（Windows TSF + macOS IMK 共用 daemon 内
...
> 签名公证产物；v0.2.7 上线：Windows 激活一律中文起步 / 安装器 daemon 生命周期，PR #94/#95）。
...
| M6 | 发布 | 打包、签名、公证、Alpha / Beta、文档与社区运营（v0.2.0–v0.2.7 已发布；v0.2.7 上线：Windows 激活默认中文 / 安装器 daemon 生命周期） | M5 |
