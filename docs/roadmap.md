...
> Slint 设置面板已落地（apps/settings）；M6 发布已达成（v0.2.0–v0.2.5
> 签名公证产物；v0.2.5 上线跨平台选区截图 OCR：mac /// 全链路）；**v0.2.6 发布准备中**（#87 盲按队列化修漏字、#88 macOS 菜单栏图标、#89 AI 三态结果浮层、#90 CapsLock 审查六项，PR #91）。
...
| M6 | 发布 | 打包、签名、公证、Alpha / Beta、文档与社区运营（v0.2.0–v0.2.5 已发布；v0.2.6 发布准备中：盲按队列化修漏字 / AI 结果浮层三态重做 / macOS 图标修复） | M5 |
