...
> Slint 设置面板已落地（apps/settings）；M6 发布已达成（v0.2.0–v0.2.4
> 签名公证产物）；**v0.2.5 发布中**（跨平台选区截图 OCR 上线：mac /// 全链路）。
...
| M6 | 发布 | 打包、签名、公证、Alpha / Beta、文档与社区运营（v0.2.0–v0.2.4 已发布；v0.2.5 发布中：跨平台选区截图 OCR 上线） | M5 |
