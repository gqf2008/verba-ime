...
> Slint 设置面板已落地（apps/settings）；M6 发布已达成（v0.2.0–v0.2.7
> 签名公证产物；v0.2.8 发布准备中：AI 发送即反馈 / 空 Enter 防误杀 / OCR 预览可发现，PR #98）。
...
| M6 | 发布 | 打包、签名、公证、Alpha / Beta、文档与社区运营（v0.2.0–v0.2.7 已发布；v0.2.8 发布准备中：AI 发送即反馈 / OCR 预览可发现） | M5 |
