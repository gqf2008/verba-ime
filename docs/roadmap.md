...
> 签名公证产物；v0.2.5 上线跨平台选区截图 OCR：mac /// 全链路）。
...
| M6 | 发布 | 打包、签名、公证、Alpha / Beta、文档与社区运营（v0.2.0–v0.2.5 已发布；v0.2.5 上线跨平台选区截图 OCR） | M5 |
...
| 2026-08-31 | v0.2.5 已发布（tag 指向 bfe35b4，DMG/exe/SHA256SUMS 校验通过）；备注：tag 树缺 roadmap 本三行历史（发布与 prep PR 并行所致，main 已补全 7f000c4） |
