...
> 签名公证产物；v0.2.6 上线：盲按队列化修漏字 / macOS 菜单栏图标 / AI 三态结果浮层 / CapsLock 审查六项，PR #91）。
...
| M6 | 发布 | 打包、签名、公证、Alpha / Beta、文档与社区运营（v0.2.0–v0.2.6 已发布；v0.2.6 上线：盲按队列化修漏字 / AI 结果浮层三态重做 / macOS 图标修复） | M5 |
