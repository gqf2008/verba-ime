...
> v0.2.13 发布中：macOS 用户级 DMG 自动启用 + IMK 连接名/markedRange 修复 + OCR 上屏竞态修复）。
...
| M6 | 发布 | 打包、签名、公证、Alpha / Beta、文档与社区运营（v0.2.0–v0.2.12 已发布；v0.2.13 发布中：macOS 自动启用 + IMK/OCR 修复） | M5 |
